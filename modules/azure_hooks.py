...
class HookIntegrationAzure(dl.BaseServiceRunner):
    def __init__(self, integration_name):
        ...
        if connection_string is not None:
            ...
            with open(os.path.join('..', 'azure_connection_string.txt'), 'r') as file:
...
def test():
    ...
    dl.setenv('rc')
    service_runner = HookIntegrationAzure(integration_name="<integration name>")
    ...
    context = dl.Context()
    context._node = Node(metadata={'customNodeConfig': {'container_name': 'micha-test'}})
